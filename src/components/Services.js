							...
							<div className="card-content">
								<p>
									<em>
										...
										asesoramiento técnico, estético y constructivo para llevar a adelante
							...
							<div className="card-content">
								<p>
									<em>
										...
										producto versátil para construcciones modernas, exigentes y
										económicas. El elemento central de la producción de madera laminada
										encolada son dos presas de alta frecuencia, permite la flexibilidad en
										la creación de secciones transversales y longitudes. Así, además de
										paquetes de productos estándar, se pueden procesar pedidos de
										proyectos y recopilar comisiones si el cliente lo desea.
									</em>
								</p>
							</div>
						</div>
							...
							<div className="card-content">
								<p>
									<em>
										...
										gracias a nuestra gestión interna. La incorporación de nuevas
										tecnología también permite que se clasifiquen mecánicamente según su
										resistencia y aspecto logrando una minuciosa supervisación casi al
										detalle.
									</em>
								</p>
							</div>
