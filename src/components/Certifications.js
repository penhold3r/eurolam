...
const Certifications = () => {
	return (
		<section className="certifications bg-color-grey" id="certificaciones">
					...
					<div className="cert-content py-4 px-1">
						...
						<div className="cert-content">
							<p className="upper text-color-white">
								...
								específicas. La fábrica cuenta con un servicio de control de calidad
								interno, equipado con un laboratorio homologado.
							</p>
							<p className="upper text-color-white">
								<strong>
									Este control de calidad es supervisado por diferentes organismos
									oficiales en función de los diferentes certificados de calidad.
								</strong>
							</p>
